"""Session-aware EasyWAM policy server for RoboDojo's XPolicyLab client."""
...
def main() -> None:
    ...
    sim_root = args.robodojo_root.expanduser().resolve()
    ...
    from experiments.robodojo.easywam_policy.deploy_policy import get_model
